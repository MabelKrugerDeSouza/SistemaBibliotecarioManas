...
namespace SistemaBibliotecarioManas.Controllers
{
    ...
    public class PessoaController : Controller
    {
        ...
        [HttpGet]
        public async Task<IActionResult> Create([FromBody] PessoaRequestModel request)
        {
            try
            {
        ...
        [Route("{id}")]
        [HttpPut]
        public async Task<IActionResult> Update([FromRoute] int id, [FromBody] PessoaRequestModel model)
        {
            try
            {
